...
class DecoderHead(nn.Module):
    ...
    def forward(self, inputs):
        ...
        # 🐛 Debug log
        # print(f"[DecoderHead] c1 shape: {c1.shape}")
        # print(f"[DecoderHead] c2 shape: {c2.shape}")
        # print(f"[DecoderHead] c3 shape: {c3.shape}")
        # print(f"[DecoderHead] c4 shape: {c4.shape}")

        assert len(c4.shape) == 4, f"Expected c4 to have 4 dimensions, but got {c4.shape}"
